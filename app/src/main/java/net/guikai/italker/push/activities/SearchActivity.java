...
import net.guikai.italker.common.app.ToolbarActivity;
import net.guikai.italker.push.R;
import net.guikai.italker.push.frags.search.SearchGroupFragment;
import net.guikai.italker.push.frags.search.SearchUserFragment;
